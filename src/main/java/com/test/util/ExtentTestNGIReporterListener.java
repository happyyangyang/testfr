...
//	    }
	    ...
	    for (Map.Entry<Class<?>, Set<ITestResult>> entry : results.entrySet()) {
	      ...
	      String testTagmessage=null;
	      String testTagtype =null;
	      String testTagproperties=null;
	      ...
	      for (TestTag testTag : testCases) {
	        if (testTag.stackTrace == null) {
	          ...
	          if (testTag.message != null) {
	            ...
	            testTagmessage = testTag.message;
	          }
	          p.setProperty("type", testTag.type);
	          testTagtype =testTag.type;
	          xsb.push(testTag.errorTag, p);
	          xsb.addCDATA(testTag.stackTrace);
	          xsb.pop(testTag.errorTag);

	          xsb.pop("testcase");
	          testTagproperties =testTag.properties.toString();
	        }
	        /*System.out.println("testTag.name:"+testTag.properties.getProperty("name"));
	        System.out.println("testTag.name:"+testTag.properties.getProperty("time"));
	        System.out.println("testTag.message:"+testTag.message);
	        System.out.println("testTag.type:"+testTag.type);
	        System.out.println("testTag.stackTrace:"+testTag.stackTrace);
	        System.out.println("testTag.errorTag:"+testTag.errorTag);*/
	        text.append("用例名："+testTag.properties.getProperty("name"));
	        text.append("\r\n");
	        text.append("报错信息："+testTag.stackTrace);
	        text.append("\r\n");
	      }
	      xsb.pop("testsuite");
	     ...
	     /* System.out.println("yhq失败的个数："+failures);
	      
	      System.out.println("yhq错误的个数是："+errors);
	      
	      System.out.println("yhq总的个数是："+testCount);
	      
	      System.out.println("yhq时间："+totalTime);
	      
	      System.out.println("开始执行时间"+begantime);
	      
	      System.out.println("testTagproperties"+testTagproperties);
	      System.out.println("testTag.type"+testTagtype);
	      System.out.println("testTag.message:"+testTagmessage);*/
	      ReportResult reportreslut = new ReportResult();
	      reportreslut.Savereporter(failures,errors,testCount,totalTime,begantime,text);
	    }
